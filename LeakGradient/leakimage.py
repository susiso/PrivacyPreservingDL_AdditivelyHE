...
def img_show(data):
    plt.figure()
    sns.heatmap(data, square=True, xticklabels=False, yticklabels=False, cmap="jet", vmin=-0.05, vmax=1.05)
    plt.savefig("./result/before.png")
...
def main():
	input_data, grad_part_b = general_neural_networks()
	...
	# (b)
	plt.figure()
	sns.heatmap(grad_part_b, square=True, xticklabels=False, yticklabels=False, cmap="jet")
